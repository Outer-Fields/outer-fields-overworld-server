...
public class PlayerEntityUpdateData extends Component<PlayerEntityUpdateData> {
    public PlayerEntityUpdateData(Entity parentEntity, ComponentType componentType, List<EventType> emittedEvents) {
...
//
//    // Reference to player session to avoid in-direction via events for performance
//    private final PlayerSession playerSession;
//
//    public PlayerEntityUpdateData(Entity parentEntity, PlayerSession playerSession) {
//        super(parentEntity, ComponentType.PLAYER_ENTITY_UPDATE_DATA, List.of(EventType.ENTITY_POSITION_CHANGED));
